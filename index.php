        ...
        <div class="carousel-inner">
            <div class="carousel-item active position-relative">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center" style="top: 0; bottom: 0; left: 0; right: 0; min-height: 100%;">
                    ...
                    <a href="#" class="btn btn-primary fw-bold px-4 py-2">Saiba Mais</a>
                </div>
            </div>
    ...
    <div class="container">
        <div class="about-content">
            <div class="about-image">
                <img src="img/primeira apresentação.jpeg" alt="Igor Jean">
            </div>
            <div class="about-text">
                <h2>Sobre Mim</h2>
                <p>Olá! Sou Igor Jean, um desenvolvedor web apaixonado por criar experiências digitais únicas e funcionais. Com experiência em desenvolvimento front-end e back-end, busco sempre entregar soluções inovadoras e de alta qualidade.</p>
                <p>Minha jornada na área de tecnologia começou há alguns anos, e desde então venho aprimorando minhas habilidades em diversas tecnologias e frameworks modernos.</p>
